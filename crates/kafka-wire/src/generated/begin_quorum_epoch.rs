...
impl KafkaDecode for BeginQuorumEpochRequestTopicData {
    fn decode(decoder: &mut Decoder, version: ApiVersion) -> Result<Self, DecodeError> {
        ...
        let partitions = {
            ...
            for _ in 0..length {
                values.push(BeginQuorumEpochRequestPartitionData::decode(
                    decoder, version,
                )?);
            }
            values
...
impl KafkaDecode for BeginQuorumEpochRequest {
    fn decode(decoder: &mut Decoder, version: ApiVersion) -> Result<Self, DecodeError> {
        ...
        let topics = {
            ...
            let mut values = Vec::with_capacity(length);
            for _ in 0..length {
                values.push(BeginQuorumEpochRequestTopicData::decode(decoder, version)?);
            }
            values
        };
        let leader_endpoints = if version.value() >= 1 {
            ...
            let mut values = Vec::with_capacity(length);
            for _ in 0..length {
                values.push(BeginQuorumEpochRequestLeaderEndpoint::decode(
                    decoder, version,
                )?);
            }
            values
...
impl KafkaDecode for BeginQuorumEpochResponseTopicData {
    fn decode(decoder: &mut Decoder, version: ApiVersion) -> Result<Self, DecodeError> {
        ...
        let partitions = {
            ...
            let mut values = Vec::with_capacity(length);
            for _ in 0..length {
                values.push(BeginQuorumEpochResponsePartitionData::decode(
                    decoder, version,
                )?);
            }
            values
...
impl KafkaDecode for BeginQuorumEpochResponse {
    fn decode(decoder: &mut Decoder, version: ApiVersion) -> Result<Self, DecodeError> {
        ...
        let topics = {
            ...
            let mut values = Vec::with_capacity(length);
            for _ in 0..length {
                values.push(BeginQuorumEpochResponseTopicData::decode(decoder, version)?);
            }
            values
        };
            ...
            unknown_tagged_fields = decoder.read_tagged_fields_with(|tag, decoder| match tag {
                0 => {
                    node_endpoints = {
                        ...
                        let mut values = Vec::with_capacity(length);
                        for _ in 0..length {
                            values.push(BeginQuorumEpochResponseNodeEndpoint::decode(
                                decoder, version,
                            )?);
                        }
                        values
