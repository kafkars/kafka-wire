...
pub mod share_group_describe_request {
    ...
    impl ProtocolEq for ShareGroupDescribeRequest {
    ...
    impl RetainedSize for ShareGroupDescribeRequest {
...
pub mod share_group_describe_response {
    ...
    impl ProtocolEq for ShareGroupDescribeResponse {
        fn protocol_eq(&self, other: &Self) -> bool {
    ...
    impl RetainedSize for ShareGroupDescribeResponse {
        fn retained_size(&self) -> RetainedFootprint {
            RetainedFootprint::EMPTY
