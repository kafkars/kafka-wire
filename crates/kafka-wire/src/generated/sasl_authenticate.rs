...
pub mod sasl_authenticate_request {
    ...
    impl RetainedSize for SaslAuthenticateRequest {
        fn retained_size(&self) -> RetainedFootprint {
            RetainedFootprint::EMPTY
                .saturating_add(RetainedSize::retained_size(&self.auth_bytes))
