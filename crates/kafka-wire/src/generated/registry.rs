...
use super::{
    ...
    API_VERSIONS_REQUEST_DESCRIPTOR, DELETE_GROUPS_REQUEST_DESCRIPTOR,
    DELETE_GROUPS_RESPONSE_DESCRIPTOR, OFFSET_DELETE_REQUEST_DESCRIPTOR,
    OFFSET_DELETE_RESPONSE_DESCRIPTOR, SASL_HANDSHAKE_REQUEST_DESCRIPTOR,
