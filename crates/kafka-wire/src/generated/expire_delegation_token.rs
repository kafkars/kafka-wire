...
pub mod expire_delegation_token_request {
    ...
    impl RetainedSize for ExpireDelegationTokenRequest {
        fn retained_size(&self) -> RetainedFootprint {
            RetainedFootprint::EMPTY
                .saturating_add(RetainedSize::retained_size(&self.hmac))
                .saturating_add(RetainedSize::retained_size(&self.expiry_time_period_ms))
...
pub mod expire_delegation_token_response {
    ...
    impl RetainedSize for ExpireDelegationTokenResponse {
        fn retained_size(&self) -> RetainedFootprint {
            RetainedFootprint::EMPTY
