...
impl KafkaDecode for DeleteShareGroupStateRequestDeleteStateData {
    fn decode(decoder: &mut Decoder, version: ApiVersion) -> Result<Self, DecodeError> {
        ...
        let partitions = {
            ...
            for _ in 0..length {
                values.push(DeleteShareGroupStateRequestPartitionData::decode(
                    decoder, version,
                )?);
            }
            values
...
impl KafkaDecode for DeleteShareGroupStateRequest {
    fn decode(decoder: &mut Decoder, version: ApiVersion) -> Result<Self, DecodeError> {
        ...
        let topics = {
            ...
            let mut values = Vec::with_capacity(length);
            for _ in 0..length {
                values.push(DeleteShareGroupStateRequestDeleteStateData::decode(
                    decoder, version,
                )?);
            }
            values
...
impl KafkaDecode for DeleteShareGroupStateResponseDeleteStateResult {
    fn decode(decoder: &mut Decoder, version: ApiVersion) -> Result<Self, DecodeError> {
        ...
        let partitions = {
            ...
            let mut values = Vec::with_capacity(length);
            for _ in 0..length {
                values.push(DeleteShareGroupStateResponsePartitionResult::decode(
                    decoder, version,
                )?);
            }
            values
...
impl KafkaDecode for DeleteShareGroupStateResponse {
    fn decode(decoder: &mut Decoder, version: ApiVersion) -> Result<Self, DecodeError> {
        ...
        let results = {
            ...
            let mut values = Vec::with_capacity(length);
            for _ in 0..length {
                values.push(DeleteShareGroupStateResponseDeleteStateResult::decode(
                    decoder, version,
                )?);
            }
            values
