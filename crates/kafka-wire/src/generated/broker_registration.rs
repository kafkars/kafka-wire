...
pub mod broker_registration_request {
    ...
    impl Listener {
        ...
        const FLEXIBLE_VERSIONS: ::core::option::Option<VersionRange> =
            ::core::option::Option::Some(VersionRange::new(0, 4));
    ...
    impl ::core::default::Default for BrokerRegistrationRequest {
        fn default() -> Self {
            Self {
                broker_id: 0,
                ...
                rack: ::core::option::Option::Some(StrBytes::default()),
                is_migrating_zk_broker: false,
                log_dirs: ::std::vec::Vec::new(),
    ...
    impl RetainedSize for BrokerRegistrationRequest {
        fn retained_size(&self) -> RetainedFootprint {
            RetainedFootprint::EMPTY
                ...
                .saturating_add(RetainedSize::retained_size(&self.is_migrating_zk_broker))
                .saturating_add(RetainedSize::retained_size(&self.log_dirs))
                .saturating_add(RetainedSize::retained_size(&self.previous_broker_epoch))
                .saturating_add(RetainedSize::retained_size(&self.unknown_tagged_fields))
        }
    }
    ...
    impl KafkaDecode for BrokerRegistrationRequest {
        fn decode(
            ...
            let __kw_field_8 = if version.value() >= 3 {
                decoder.read_i64()?
            } else {
                -1
            };
            ...
            ::core::result::Result::Ok(Self {
                ...
                cluster_id: __kw_field_1,
                incarnation_id: __kw_field_2,
                listeners: __kw_field_3,
                features: __kw_field_4,
                rack: __kw_field_5,
                is_migrating_zk_broker: __kw_field_6,
                log_dirs: __kw_field_7,
                previous_broker_epoch: __kw_field_8,
                unknown_tagged_fields,
            })
        }
    }
...
pub mod broker_registration_response {
    ...
    impl ::core::default::Default for BrokerRegistrationResponse {
        fn default() -> Self {
            Self {
                throttle_time_ms: 0,
                error_code: 0,
    ...
    impl RetainedSize for BrokerRegistrationResponse {
        fn retained_size(&self) -> RetainedFootprint {
            RetainedFootprint::EMPTY
