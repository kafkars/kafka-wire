...
impl ConsumerGroupHeartbeatRequestTopicPartitions {
...
impl KafkaDecode for ConsumerGroupHeartbeatRequestTopicPartitions {
...
impl KafkaEncode for ConsumerGroupHeartbeatRequestTopicPartitions {
...
pub struct ConsumerGroupHeartbeatRequest {
    ...
    pub topic_partitions: Option<Vec<ConsumerGroupHeartbeatRequestTopicPartitions>>,
    /// Unknown flexible-version tagged fields retained for forwarding.
    pub unknown_tagged_fields: TaggedFields,
}
...
impl KafkaEncode for ConsumerGroupHeartbeatRequest {
    fn encode<T: EncodeTarget>(
        ...
        encoder.write_compact_nullable_array_len(self.topic_partitions.as_ref().map(Vec::len))?;
...
impl ConsumerGroupHeartbeatResponseTopicPartitions {
    const FLEXIBLE_VERSIONS: Option<VersionRange> = Some(VersionRange::new(0, 1));
...
impl KafkaDecode for ConsumerGroupHeartbeatResponseTopicPartitions {
    fn decode(decoder: &mut Decoder, version: ApiVersion) -> Result<Self, DecodeError> {
        let topic_id = decoder.read_uuid()?;
        let partitions = {
            let length = decoder.read_compact_array_len()?;
...
impl KafkaEncode for ConsumerGroupHeartbeatResponseTopicPartitions {
    fn encode<T: EncodeTarget>(
        &self,
        encoder: &mut Encoder<T>,
        version: ApiVersion,
...
pub struct ConsumerGroupHeartbeatResponseAssignment {
    ...
    pub topic_partitions: Vec<ConsumerGroupHeartbeatResponseTopicPartitions>,
    /// Unknown flexible-version tagged fields retained for forwarding.
    pub unknown_tagged_fields: TaggedFields,
}

impl ConsumerGroupHeartbeatResponseAssignment {
    const FLEXIBLE_VERSIONS: Option<VersionRange> = Some(VersionRange::new(0, 1));
...
impl KafkaDecode for ConsumerGroupHeartbeatResponseAssignment {
    fn decode(decoder: &mut Decoder, version: ApiVersion) -> Result<Self, DecodeError> {
        let topic_partitions = {
            let length = decoder.read_compact_array_len()?;
            let mut values = Vec::with_capacity(length);
...
impl KafkaEncode for ConsumerGroupHeartbeatResponseAssignment {
    fn encode<T: EncodeTarget>(
        &self,
        encoder: &mut Encoder<T>,
        version: ApiVersion,
...
pub struct ConsumerGroupHeartbeatResponse {
    ...
    pub assignment: Option<ConsumerGroupHeartbeatResponseAssignment>,
    /// Unknown flexible-version tagged fields retained for forwarding.
    pub unknown_tagged_fields: TaggedFields,
}
...
impl KafkaDecode for ConsumerGroupHeartbeatResponse {
    fn decode(decoder: &mut Decoder, version: ApiVersion) -> Result<Self, DecodeError> {
        ...
        let assignment = if decoder.read_struct_presence()? {
            Some(ConsumerGroupHeartbeatResponseAssignment::decode(
                decoder, version,
            )?)
        } else {
            None
