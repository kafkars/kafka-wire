...
impl KafkaDecode for VoteRequestTopicData {
...
impl KafkaEncode for VoteRequestTopicData {
...
impl KafkaDecode for VoteRequestPartitionData {
    fn decode(decoder: &mut Decoder, version: ApiVersion) -> Result<Self, DecodeError> {
...
impl KafkaEncode for VoteRequestPartitionData {
    fn encode<T: EncodeTarget>(
        &self,
        encoder: &mut Encoder<T>,
        version: ApiVersion,
...
impl KafkaDecode for VoteResponseTopicData {
    fn decode(decoder: &mut Decoder, version: ApiVersion) -> Result<Self, DecodeError> {
        let topic_name = decoder.read_compact_string()?;
        let partitions = {
            let length = decoder.read_compact_array_len()?;
...
impl KafkaEncode for VoteResponseTopicData {
    fn encode<T: EncodeTarget>(
        &self,
        encoder: &mut Encoder<T>,
        version: ApiVersion,
...
impl VoteResponsePartitionData {
    const FLEXIBLE_VERSIONS: Option<VersionRange> = Some(VersionRange::new(0, 2));
...
impl KafkaDecode for VoteResponsePartitionData {
    fn decode(decoder: &mut Decoder, version: ApiVersion) -> Result<Self, DecodeError> {
        let partition_index = decoder.read_i32()?;
...
impl KafkaEncode for VoteResponsePartitionData {
    fn encode<T: EncodeTarget>(
        &self,
        encoder: &mut Encoder<T>,
        version: ApiVersion,
...
impl KafkaDecode for VoteResponseNodeEndpoint {
    fn decode(decoder: &mut Decoder, version: ApiVersion) -> Result<Self, DecodeError> {
...
impl KafkaEncode for VoteResponseNodeEndpoint {
    fn encode<T: EncodeTarget>(
        &self,
        encoder: &mut Encoder<T>,
        version: ApiVersion,
