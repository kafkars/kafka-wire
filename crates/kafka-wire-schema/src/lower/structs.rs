...
//! module-local collision the uniqueness guard must report.
...
/// upstream wrote the declarations in. Changing the naming scope does not
/// change that generated-item order.
