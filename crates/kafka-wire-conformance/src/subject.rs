...
use kafka_wire::{
    ...
    ShareGroupHeartbeatRequest, ShareGroupHeartbeatResponse, SnapshotFooterRecord,
    SnapshotHeaderRecord, StreamsGroupDescribeRequest, StreamsGroupDescribeResponse,
    ...
    UpdateFeaturesResponse, UpdateRaftVoterRequest, UpdateRaftVoterResponse, VoteRequest,
    VoteResponse, VotersRecord, WriteShareGroupStateRequest, WriteShareGroupStateResponse,
